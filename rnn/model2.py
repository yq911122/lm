...
import random
from reader import astro_producer
...
trainset = astro_producer(n_samples=1000, max_seq_len=seq_max_len)
testset = astro_producer(n_samples=500, max_seq_len=seq_max_len)
